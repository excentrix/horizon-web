    ...
    <main className="pt-24 pb-16 bg-white">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="max-w-none text-black">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-black">2. Compliance with DPDP Act, 2023</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-black">3. Data We Collect</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-4 text-black">4. How We Use Your Data</h2>
            <p>
