            ...
            onEnter: () => {
              gsap.from(
                { value: 0 },
                {
                  ...
                  ease: 'power2.out',
                  onUpdate: function () {
                    const suffix = endValue.includes('%') ? '%' : endValue.includes('x') ? 'x' : ''
                    numberEl.textContent = this.targets()[0].value.toFixed(1) + suffix
                  },
                },
              )
            },
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div ref={headerRef} className="mb-20 md:mb-32">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <p className="font-mono text-sm mb-4 tracking-widest">SECTION_01</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20 md:mb-32">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="font-mono text-sm opacity-60">{stat.sublabel}</div>
            </div>
          ))}
        </div>
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {painPoints.map((point, index) => (
              <div
                key={index}
                ref={(el) => (painPointsRef.current[index] = el)}
              ...
              >
                ...
                <h4 className="text-xl md:text-2xl font-black mb-3">{point.title}</h4>
                <p className="font-mono text-sm md:text-base leading-relaxed">{point.desc}</p>
