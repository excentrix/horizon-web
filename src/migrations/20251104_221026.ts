...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_case_studies_metrics_icon" AS ENUM('trend-up', 'clock', 'target', 'trophy', 'chart');
  CREATE TYPE "public"."enum_case_studies_year_in_school" AS ENUM('freshman', 'sophomore', 'junior', 'senior', 'graduate');
  CREATE TYPE "public"."enum_case_studies_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__case_studies_v_version_metrics_icon" AS ENUM('trend-up', 'clock', 'target', 'trophy', 'chart');
  CREATE TYPE "public"."enum__case_studies_v_version_year_in_school" AS ENUM('freshman', 'sophomore', 'junior', 'senior', 'graduate');
  CREATE TYPE "public"."enum__case_studies_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_resources_type" AS ENUM('study-guide', 'template', 'cheat-sheet', 'video', 'podcast', 'webinar', 'ebook');
  ...
  CREATE TYPE "public"."enum__resources_v_version_type" AS ENUM('study-guide', 'template', 'cheat-sheet', 'video', 'podcast', 'webinar', 'ebook');
  CREATE TYPE "public"."enum__resources_v_version_difficulty" AS ENUM('beginner', 'intermediate', 'advanced');
  ...
  CREATE TYPE "public"."enum_settings_announcement_bar_background_color" AS ENUM('blue', 'green', 'orange', 'red', 'purple');
  ...
  CREATE TABLE "case_studies_metrics" (
  	...
  	"label" varchar,
  	"value" varchar,
  	"icon" "enum_case_studies_metrics_icon"
  );
  ...
  CREATE TABLE "case_studies" (
  	...
  	"institution" varchar,
  	"major" varchar,
  	"year_in_school" "enum_case_studies_year_in_school",
  	"gpa" numeric,
  	"challenge" varchar,
  	"solution" varchar,
  	"outcome" varchar,
  ...
  CREATE TABLE "_case_studies_v_version_metrics" (
  	...
  	"label" varchar,
  	"value" varchar,
  	"icon" "enum__case_studies_v_version_metrics_icon",
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_case_studies_v" (
  	...
  	"version_student_photo_id" integer,
  	"version_institution" varchar,
  	"version_major" varchar,
  	"version_year_in_school" "enum__case_studies_v_version_year_in_school",
  	"version_gpa" numeric,
  	...
  	"version_video_testimonial" varchar,
  	"version_meta_title" varchar,
  	"version_meta_image_id" integer,
  	"version_meta_description" varchar,
  	"version_generate_slug" boolean DEFAULT true,
  ...
  CREATE TABLE "_resources_v" (
  	...
  	"version_difficulty" "enum__resources_v_version_difficulty",
  ...
  CREATE TABLE "settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT 'Horizon' NOT NULL,
  	"site_description" varchar DEFAULT 'Transform your learning experience with AI-powered study tools' NOT NULL,
  	"logo_id" integer,
  	"favicon_id" integer,
  	...
  	"analytics_mixpanel_token" varchar,
  	...
  	"announcement_bar_background_color" "enum_settings_announcement_bar_background_color" DEFAULT 'blue',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_student_photo_id_media_id_fk" FOREIGN KEY ("student_photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_before_after_before_id_media_id_fk" FOREIGN KEY ("before_after_before_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "case_studies" ADD CONSTRAINT "case_studies_before_after_after_id_media_id_fk" FOREIGN KEY ("before_after_after_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_student_photo_id_media_id_fk" FOREIGN KEY ("version_student_photo_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_before_after_before_id_media_id_fk" FOREIGN KEY ("version_before_after_before_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_case_studies_v" ADD CONSTRAINT "_case_studies_v_version_before_after_after_id_media_id_fk" FOREIGN KEY ("version_before_after_after_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_resources_v" ADD CONSTRAINT "_resources_v_version_thumbnail_id_media_id_fk" FOREIGN KEY ("version_thumbnail_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_resources_v" ADD CONSTRAINT "_resources_v_version_download_file_id_media_id_fk" FOREIGN KEY ("version_download_file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "case_studies_student_photo_idx" ON "case_studies" USING btree ("student_photo_id");
  CREATE INDEX "case_studies_before_after_before_after_before_idx" ON "case_studies" USING btree ("before_after_before_id");
  CREATE INDEX "case_studies_before_after_before_after_after_idx" ON "case_studies" USING btree ("before_after_after_id");
  ...
  CREATE INDEX "_case_studies_v_version_version_student_photo_idx" ON "_case_studies_v" USING btree ("version_student_photo_id");
  CREATE INDEX "_case_studies_v_version_before_after_version_before_afte_idx" ON "_case_studies_v" USING btree ("version_before_after_before_id");
  CREATE INDEX "_case_studies_v_version_before_after_version_before_af_1_idx" ON "_case_studies_v" USING btree ("version_before_after_after_id");
  ...
  CREATE INDEX "_resources_v_version_version_thumbnail_idx" ON "_resources_v" USING btree ("version_thumbnail_id");
  CREATE INDEX "_resources_v_version_version_download_file_idx" ON "_resources_v" USING btree ("version_download_file_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_case_studies_metrics_icon";
  DROP TYPE "public"."enum_case_studies_year_in_school";
  DROP TYPE "public"."enum_case_studies_status";
  DROP TYPE "public"."enum__case_studies_v_version_metrics_icon";
  DROP TYPE "public"."enum__case_studies_v_version_year_in_school";
  ...
  DROP TYPE "public"."enum__resources_v_version_difficulty";
  ...
  DROP TYPE "public"."enum_settings_announcement_bar_background_color";`)
}
