...
export interface Page {
  ...
  layout: (CallToActionBlock | ContentBlock | MediaBlock | ArchiveBlock | FormBlock | WaitlistBlock)[];
  meta?: {
    title?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WaitlistBlock".
 */
...
export interface CaseStudy {
  ...
  gpa?: number | null;
  /**
   * What problem was the student facing?
   */
  challenge: string;
  /**
  ...
  metrics?:
    | {
        label: string;
        value: string;
        icon?: ('trend-up' | 'clock' | 'target' | 'trophy' | 'chart') | null;
        id?: string | null;
      }[]
    | null;
  beforeAfter?: {
    /**
     * Screenshot or image showing "before" state
     */
    before?: (number | null) | Media;
    /**
     * Screenshot or image showing "after" state
     */
...
export interface Resource {
  id: number;
  title: string;
  type: 'study-guide' | 'template' | 'cheat-sheet' | 'video' | 'podcast' | 'webinar' | 'ebook';
  description: string;
...
export interface PagesSelect<T extends boolean = true> {
  ...
  layout?:
    ...
    | {
        ...
        waitlist?: T | WaitlistBlockSelect<T>;
      };
  meta?:
    | T
    | {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WaitlistBlock_select".
 */
export interface WaitlistBlockSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  id?: T;
  blockName?: T;
...
export interface Setting {
  ...
  announcementBar?: {
    ...
    linkUrl?: string | null;
    backgroundColor?: ('blue' | 'green' | 'orange' | 'red' | 'purple') | null;
  };
  updatedAt?: string | null;
  createdAt?: string | null;
}
